...
export default function AddOrEditProjectPage(): React.ReactElement {
        ...
        <section className="rounded-2xl border border-secondary-light bg-white p-6 shadow-soft">
            ...
            <form onSubmit={handleSubmit} className="mt-4 grid max-w-lg gap-4">
                ...
                <div className="mt-2 flex gap-3">
                    <button type="submit" disabled={loading || prefilling} className="rounded-lg border border-acc-light bg-acc-light px-4 py-2 text-bg-light hover:opacity-90 disabled:opacity-60">{loading ? "Zapisywanie…" : isEdit ? "Zapisz zmiany" : "Dodaj projekt"}</button>
                    {isEdit && (
